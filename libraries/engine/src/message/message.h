...
namespace engine {
    ...
    public:
        ...
        static constexpr size_t magic_number { 0x31337fe0 };
        ...
        u32 length() const noexcept { return *reinterpret_cast<u32 *>(&_memory[LENGTH_OFFSET]); }
        u32 crc32() const noexcept { return *reinterpret_cast<u32 *>(&_memory[CRC32_OFFSET]); }
    ...
    private:
        ...
        static constexpr size_t LENGTH_OFFSET { 8 };
        static constexpr size_t CRC32_OFFSET { 12 };
