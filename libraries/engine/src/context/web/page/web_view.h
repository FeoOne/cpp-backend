...
namespace engine {
    ...
    class view_template {
    public:
        STL_DECLARE_SMARTPOINTERS(view_template)
        STL_DELETE_ALL_DEFAULT(view_template)
    ...
    class web_view {
    public:
        STL_DECLARE_SMARTPOINTERS(web_view)
        STL_DELETE_ALL_DEFAULT(web_view)
    ...
    private:
        class argument {
        public:
            STL_DECLARE_SMARTPOINTERS(argument)
            STL_DELETE_ALL_DEFAULT(argument)
