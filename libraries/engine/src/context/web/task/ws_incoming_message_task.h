...
#ifndef ENGINE_WS_INCOMING_MESSAGE_TASK_H
#define ENGINE_WS_INCOMING_MESSAGE_TASK_H
...
namespace engine {
    ...
    class ws_incoming_message_task : public stl::crucial<basic_task, ws_incoming_message_task> {
    public:
        STL_DECLARE_SMARTPOINTERS(ws_incoming_message_task)
        STL_DELETE_ALL_DEFAULT(ws_incoming_message_task)
...
#endif /* ENGINE_WS_INCOMING_MESSAGE_TASK_H */
