...
namespace engine {
    ...
    tcp_connection::tcp_connection(ip_version version,
                                   side_t side,
                                   kind_t kind) noexcept :
            connection(network_protocol::TCP, version, side, kind)
    {
    }
    ...
    bool tcp_connection::bind(socket_address *addr) noexcept
    {
    ...
    uv_connect_t *tcp_connection::connect(framework::socket_address *addr, uv_connect_cb cb) noexcept
    {
